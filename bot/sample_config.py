...
class Config(object):
    ...
    CANCEL_COMMAND_J = os.environ.get("CANCEL_COMMAND_J", "cancel")
    ...
    UPLOAD_AS_DOC = os.environ.get("UPLOAD_AS_DOC", "upload_as_doc")
    PYTDL_COMMAND_J = os.environ.get("PYTDL_COMMAND_J", "pytdl")
